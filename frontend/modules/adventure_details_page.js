...
function addAdventureDetailsToDOM(adventure) {
 ...
 var gallery = document.getElementById("photo-gallery");
  for (var i = 0; i < adventure.images.length; i++) {
    ...
    image.classList.add("img-fluid", "activity-card-image");
...
function captureFormSubmit(adventure) {
  ...
  if (result.success) {
    alert('Success!');
    location.reload(); // Refresh the page to show the updated reservation
  } else {
    alert('Failed!');
  }
})
...
// Replace with your actual API endpoint UR 
